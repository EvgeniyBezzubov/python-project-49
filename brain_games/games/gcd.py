...
def generate_math_func_and_result_gcd():
    generated_random_num_1 = rand_1_100()
    generated_random_num_2 = rand_1_100()
...
def start_game_gcd():
    start_game(GCD_INSTRUCTION, generate_math_func_and_result_gcd)
